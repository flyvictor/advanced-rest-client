(function() {
     ...
     * @constructor
     */
    var BaseHttpRequest = EventSource.extend({
        init: function(opts) {
            this._super();
            this.listeners_ = {};
            //current ready state
     ...
     */
    var ChromeHttpRequestImplementation = BaseHttpRequest.extend({
        init: function(opts) {
            this._super(opts);
            /**
     ...
     * @constructor
     */
    var HttpRequest = EventSource.extend({
        init: function(opts) {
            this._super();
            if (opts && opts.load) {
